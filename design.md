# SmashVision AI: Design & Architecture Document

## 1. High-Level Architecture
SmashVision AI utilizes a **Hybrid Edge-Cloud Architecture** to ensure accessibility even in low-bandwidth rural areas ("Bharat").
